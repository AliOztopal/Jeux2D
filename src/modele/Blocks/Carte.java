...
public class Carte {
	...
	private ObservableList<Blocks> obsListe = FXCollections.observableArrayList();
	...
	public Carte(ObservableList<Blocks> obliste) {
	...
	// Creation de block & insertion dans la liste Observable

	
	public void creeBlock(String valeur) {
		Blocks block;
